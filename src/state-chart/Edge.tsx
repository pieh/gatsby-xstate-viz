...
export class Edge extends Component<EdgeProps, EdgeState> {
  state = {
    ...
    sourceElement: null,
    targetElement: null,
    sourceData: tracker.get(this.props.serviceID, this.props.edge.source.id),
    targetData: tracker.get(this.props.serviceID, this.props.edge.target.id),
    eventData: tracker.get(
      this.props.serviceID,
      serializeEdge(this.props.edge)
    ),
  }
  ...
  componentDidMount() {
    ...
    tracker.listen(this.props.serviceID, eventId, data => {
      this.setState({ eventData: data })
    })

    tracker.listen(this.props.serviceID, edge.source.id, data => {
      this.setState({ sourceData: data })
    })

    tracker.listen(this.props.serviceID, edge.target.id, data => {
      ...
      while (isHidden(parentData.element)) {
        ...
        parentData = tracker.get(this.props.serviceID, target.id)
  ...
  render() {
    const { edge, serviceID } = this.props
